...
<body id="page-top">
	...
	<div id="content-wrapper">
		...
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				<li class="breadcrumb-item active">Tabela de Froma de Pagamento</li>
			</ol>

			<div class="card mb-3">
				<div class="card-header">
					<i class="fas fa-table"></i>
					Tabela de Forma de Pagamento</div>
				<div class="card-body">
					<div class="table-responsive">
						<?php
						include '../pagamento/select_pagamento.php';
						?>
					</div>
				</div>
	...
	<script>
		...
		function changeData(id) {
			btnRemove.href = `delete_pagamento.php?id=${id}`
		}
	</script>
</body>
