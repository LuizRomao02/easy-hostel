...
<body id="page-top">
	...
	<div id="content-wrapper">
		...
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				<li class="breadcrumb-item active">Cadastro de Tipo de Pagamento</li>
			</ol>

			<form onsubmit="insert(event); return false" class="card m-5" method="post">
				<div class="card-header"><i class="fas fa-plus mr-2"></i>Cadastrar um Tipo de Pagamento</div>
				<div class="form-row m-4">
					<div class="col-md-12 mb-4">
						<label for="Tipo">Tipo de Pagamento</label>
						<input type="text" class="form-control" name="tipo" placeholder="Tipo de Pagamento" required>
					</div>
					<div class="col-md-12 mb-4">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>A Forma de Pagamento foi cadastrado com Sucesso!</p>
					</div>
	...
	<script>
		...
		async function insert(e) {
			...
			const data = await (await fetch('insert_pagamento.php', {
				method: 'POST',
				body: formData
			})).json()
