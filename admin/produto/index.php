...
<body id="page-top">
	...
	<div id="content-wrapper">
		...
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				<li class="breadcrumb-item active">Cadastro do Produto</li>
			</ol>

			<form onsubmit="insert(event); return false" class="card m-5" method="post">
				<div class="card-header"><i class="fas fa-plus mr-2"></i>Cadastrar Produto</div>
	...
	<script>
		...
		async function insert(e) {
			...
			const data = await (await fetch('insert_produto.php', {
				method: 'POST',
				body: formData
			})).json()
