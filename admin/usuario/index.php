...
<body id="page-top">
	...
	<div id="content-wrapper">
		...
		<div class="container-fluid">
			...
			<form onsubmit="insert(event); return false" class="card m-5" method="POST">
				<div class="card-header"><i class="fas fa-plus mr-2"></i>Registre uma Conta</div>
				<div class="form-row m-4">
					...
					<div class="col-md-4 mb-4">
						...
						<input type="password" name="resenha" class="form-control" placeholder="Re-Senha" required>
					</div>
					<div class="col-md-12 mb-4">
						<label for="email">Digite E-mail ou Usuário</label>
						<input type="text" name="email" class="form-control" placeholder="Ex: Pousada" required>
					</div>
	...
	<script>
		...
		async function insert(e) {
			...
			const data = await (await fetch('insert_usuario.php', {
				method: 'POST',
				body: formData
			})).json()
