...
<body id="page-top">
	...
	$sth = $pdo->prepare("select * from qua_quarto where qua_id = :id");
	...
	<div id="content-wrapper">
		...
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				<li class="breadcrumb-item active">Atualizar Informações de Quarto</li>
			</ol>

			<form class="card m-5" onsubmit="insert(event); return false" method="post">
				<div class="card-header"><i class="far fa-edit mr-2"></i>Atualizar Informações Quarto</div>
				<div class="form-row m-4">
					<div class="col-md-4 mb-4">
						<input type="hidden" name="id" value="<?= $qua_id; ?>" />
						<label for="Numero">Alterar Número</label>
						<input type="number" class="form-control" name="numero" placeholder="Número" value="<?= $qua_numero; ?>" required>
					</div>
					<div class="col-md-4 mb-4">
						<label for="Valor">Alterar Valor</label>
						<input type="text" class="form-control" name="valor" id="preco" placeholder="Valor" value="<?= $qua_valor; ?>" required>
					</div>
					<div class="col-md-4 mb-4">
						<label for="Andar">Alterar Andar</label>
						<input type="text" class="form-control" name="andar" placeholder="Andar" value="<?= $qua_andar; ?>" required>
					</div>
					<div class="col-md-6 mb-4">
						<label for="Descricao">Alterar Descrição</label>
						<input type="text" class="form-control" name="descricao" placeholder="Descrição" value="<?= $qua_descricao; ?>" required>
					</div>
					<div class="col-md-6">
						<label for="Tipo">Tipo</label>
						<input type="text" class="form-control" name="tipo" placeholder="Mudar Campo na Tabela Tipo de Quarto" readonly="true" required>
					</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>O Quarto foi atualizado com Sucesso!</p>
					</div>
	...
	<script>
		...
		async function insert(e) {
			...
			const data = await (await fetch('update_quarto.php', {
				method: 'POST',
				body: formData
			})).json()
