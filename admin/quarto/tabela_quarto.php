...
<body id="page-top">
	...
	<div id="content-wrapper">
		...
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				<li class="breadcrumb-item active">Tabela de Quartos</li>
			</ol>

			<div class="card mb-3">
				<div class="card-header">
					<i class="fas fa-table"></i>
					Tabela de Quartos</div>
				<div class="card-body">
					<div class="table-responsive">
						<?php
						include 'select_quarto.php';
						?>
					</div>
				</div>
	...
	<script>
		...
		function changeData(id) {
			btnRemove.href = `delete_quarto.php?id=${id}`
		}
	</script>
