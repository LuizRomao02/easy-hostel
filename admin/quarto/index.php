...
<body id="page-top">
	...
	<div id="content-wrapper">
		...
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				<li class="breadcrumb-item active">Cadastro de Quarto</li>
			</ol>

			<form onsubmit="insert(event); return false" class="card m-5" method="post">
				<div class="card-header"><i class="fas fa-plus mr-2"></i>Cadastrar Quarto</div>
				<div class="form-row m-4">
					...
					<div class="col-md-4 mb-4">
						...
						<input type="text" class="form-control" name="valor" id="preco" placeholder="Valor" required>
					</div>
					<div class="col-md-4 mb-4">
						<label for="Andar">Andar</label>
						<input type="text" class="form-control" name="andar" placeholder="Andar" required>
					</div>
					...
					<div class="col-md-6">
						...
						<select class="custom-select" name="tipo" required>
							...
							foreach ($sth as $res) {
								extract($res);
								echo '<option value="' . $tip_id . '">' . $tip_nome . '</option>';
							}
							?>
						</select>
					</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>O Quarto foi cadastrado com Sucesso!</p>
					</div>
	...
	<script>
		...
		async function insert(e) {
			...
			const data = await (await fetch('insert_quarto.php', {
				method: 'POST',
				body: formData
			})).json()
