...
<body id="page-top">
	...
	<div id="content-wrapper">
		...
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				<li class="breadcrumb-item active">Tabela de Reserva</li>
			</ol>

			<div class="card mb-3">
				<div class="card-header">
					<i class="fas fa-table"></i>
					Tabela de Reservas</div>
				<div class="card-body">
					<div class="table-responsive">
						<?php
						include 'select_reserva.php';
						?>
					</div>
				</div>
	...
	<script>
		...
		$(document).ready(function() {
			...
			$('[data-toggle="imp"]').tooltip();
		});

		function changeData(id) {
			btnRemove.href = `delete_reserva.php?id=${id}`
		}
	</script>
