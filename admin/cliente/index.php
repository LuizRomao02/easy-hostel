...
<body id="page-top">
	...
	<div id="content-wrapper">
		...
		<div class="container-fluid">
			...
			<form onsubmit="insert(event); return false" class="card m-5" method="POST">
				<div class="card-header"><i class="fas fa-plus mr-2"></i>Cadastrar Cliente</div>
				<div class="form-row m-4">
					...
					<div class="col-md-6 mb-4">
						...
						<input type="text" class="form-control" name="telefone" id="tel" placeholder="Telefone Residencial" required>
					</div>
					<div class="col-md-6 mb-4">
						<label for="Celular">Celular</label>
						<input type="text" class="form-control" name="celular" id="cel" placeholder="Celular" required>
					</div>
					<div class="col-md-3 mb-4">
						<label for="Cep">Cep</label>
						<div class="input-group">
							<input type="text" id="cep" class="form-control" name="cep" placeholder="Cep" aria-label="Search" aria-describedby="basic-addon2" required>
					...
					<div class="col-md-3 mb-4">
						...
						<input type="text" id="uf" class="form-control" name="estado" placeholder="Estado" required>
					</div>
					<div class="col-md-3 mb-4">
						<label for="Cidade">Cidade</label>
						<input type="text" id="cidade" class="form-control" name="cidade" placeholder="Cidade" required>
					</div>
					<div class="col-md-3 mb-4">
					...
					<div class="col-md-5 mb-4">
						...
						<input type="text" id="rua" class="form-control" name="rua" placeholder="Rua" required>
					</div>
					<div class="col-md-5 mb-4">
	...
	<script>
		...
		async function insert(e) {
			...
			const data = await (await fetch('insert_cliente.php', {
				method: 'POST',
				body: formData
			})).json()
